    ...
    <body>
        ...
        <br>
            <form class="col s12" action="novo" method="post" >
                <div><h5 style="text-align: center;" ><i class="material-icons">account_box</i> Cadastro de paciente</h5></div>
                <div class="row">
                    <div class="input-field col s6 offset-s3 ">
                        <label class="active" for="name">Nome </label>
                        <input type="text" id="name" name="patient.name" class="validate">
                    </div>
                    <div class="input-field col s6 offset-s3 ">
                        <label class="active" for="rg">Rg </label>
                        <input type="text" id="rg" name="patient.rg" class="validate">
                    </div>
                    <div class="input-field col s6 offset-s3 ">
                        <label class="active" for="age">Idade</label>
                        <input type="text" id="age" name="patient.age" class="validate">
                    </div>
                    <div class="input-field col s6 offset-s3 ">
                        <label class="active" for="weight">Peso</label>
                        <input type="text" id="weight" name="patient.weight" class="validate">
